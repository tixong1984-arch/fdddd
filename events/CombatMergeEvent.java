...
public class CombatMergeEvent
extends CombatDamageEvent {
    private static final HandlerList handlers = new HandlerList();

    public CombatMergeEvent(@NotNull IUser damager, @NotNull IUser target) {
        super(damager, target);
    }

    public CombatMergeEvent(@NotNull IUser damager, @NotNull IUser target, @Nullable EntityDamageEvent.DamageCause cause) {
