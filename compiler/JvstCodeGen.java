...
import org.codemc.worldguardwrapper.shaded.javassist.compiler.MemberCodeGen;
import org.codemc.worldguardwrapper.shaded.javassist.compiler.MemberResolver;
import org.codemc.worldguardwrapper.shaded.javassist.compiler.ProceedHandler;
...
extends MemberCodeGen {
    ...
    public void atMember(Member mem) throws CompileError {
        ...
        if (name.equals(this.paramArrayName)) {
            ...
            this.bytecode.addInvokestatic("org/codemc/worldguardwrapper/shaded/javassist/runtime/Desc", "getParams", "(Ljava/lang/String;)[Ljava/lang/Class;");
            this.exprType = 307;
            this.arrayDim = 1;
    ...
    private void callGetType(String method) {
        this.bytecode.addInvokestatic("org/codemc/worldguardwrapper/shaded/javassist/runtime/Desc", method, "(Ljava/lang/String;)Ljava/lang/Class;");
        this.exprType = 307;
        this.arrayDim = 0;
        this.className = "java/lang/Class";
    }
    ...
    protected void atCflow(ASTList cname) throws CompileError {
        ...
        this.bytecode.addGetstatic((String)names[0], (String)names[1], "Lorg/codemc/worldguardwrapper/shaded/javassist/runtime/Cflow;");
        this.bytecode.addInvokevirtual("org.codemc.worldguardwrapper.shaded.javassist.runtime.Cflow", "value", "()I");
        this.exprType = 324;
        this.arrayDim = 0;
        this.className = null;
    }
