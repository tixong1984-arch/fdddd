...
import org.codemc.worldguardwrapper.shaded.javassist.CodeConverter;
...
import org.codemc.worldguardwrapper.shaded.javassist.expr.ExprEditor;
    ...
    public void useCflow(String name) throws CannotCompileException {
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    CtClass type = pool.get("org.codemc.worldguardwrapper.shaded.javassist.runtime.Cflow");
